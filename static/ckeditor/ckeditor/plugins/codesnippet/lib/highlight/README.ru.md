...
Весь код на странице, обрамлённый в Tags `<pre><code> .. </code></pre>`
будет автоматически подсвечен. Если вы используете другие Tags или хотите
...
Если вы используете другие Tags для блоков кода, вы можете инициализировать их
